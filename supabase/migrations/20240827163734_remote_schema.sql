...
CREATE POLICY "All athenticated users All operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow athenticated users to SELECT" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
